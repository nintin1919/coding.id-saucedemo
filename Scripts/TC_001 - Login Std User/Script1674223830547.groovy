...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_concat(Epic sadface You can only acce_8f3e31'), 'standard_user')
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_ProductsPrice (low to high)Name (A to Z_91847c'))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '009')
